...
class KsUrl(object):
    ...
    def search_on_db(self):
        ...
        if self.is_sintactically_correct:
            ...
            try:
                self.knowledge_server = ks.models.KnowledgeServer.objects.using('materialized').get(scheme=self.scheme,
                                                                                                    netloc=self.netloc)
            ...
            try:
                self.actual_class = ks.orm_wrapper.OrmWrapper.load_class(self.netloc, self.namespace, self.class_name)
            except:
                pass
